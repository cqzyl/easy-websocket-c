...
})({"1kMbH":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "4a4529a8a74943b4";
"use strict";
...
},{}],"fnkGs":[function(require,module,exports,__globalThis) {
...
class EasyWebSocketC extends (0, _attribute.EasyWebSocketCAttribute) {
    constructor(options){
        super(options), /* ****************** 网络 ****** end ****************** */ /* ****************** 报错重连检测 ****** start ****************** */ /** 报错重连timer */ this.timeWatchTimer = null, /* ****************** 报错重连检测 ****** end ****************** */ /* ****************** 心跳检测 ****** start ****************** */ /** 维护心跳包发送的定时器 */ this.hearTimer = null, /** 心跳响应超时定时器 */ this.heartTimeoutTimer = null, /** 上一次接收消息的时间 */ this.heartOldTime = 0, /** 心跳尝试次数 */ this.heartTryNumber = 0;
    }
    /* ****************** 网络 ****** start ****************** */ /**
   * 断网检测
   * 断网后自动清除 socket 实例
   */ startOfflineWatch() {
    ...
    /** 收到心跳包（收到任何消息都可以认为是心跳包），更新心跳包时间 */ onHeart() {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["1kMbH","fnkGs"], "fnkGs", "parcelRequire6539", {})

//# sourceMappingURL=test.a74943b4.js.map
